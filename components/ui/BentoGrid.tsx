    ...
    return (
        <div
            ...
            style={{
                ...
                backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(13,13,25,1) 35%, rgba(0,212,255,1) 100%)'
            }}
        >
            ...
            <div className={`${id === 6} && 'flex justify-center h-full`}>
                ...
                {id === 6 && (
                    <BackgroundGradientAnimation>
                        <div className="z-50 flex items-center justify-center text-white font-bold
                ...
                <div className={cn(
                    titleClassName, 'group-hover/beno:translate-x-2 transition duration-2 relative md:h-full flex flex-col px-5 p-5 lg:p-10'
                )}>
